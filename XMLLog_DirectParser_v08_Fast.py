#!/usr/bin/env python3
"""
XMLLog_DirectParser_v07_Fast.py

Phase 2A multiprocessing parser for Sakura XML MasterLog extraction.
Updated with customized column list and Whitelist metadata fields.
"""
...
def main(argv: Optional[list[str]] = None) -> int:
    ap = argparse.ArgumentParser(description="Phase 2A multiprocessing XML parser with v07 streaming & node skipping optimizations.")
    ...
    ap.add_argument("--out", default="Master_XML_Log_Direct_v07_Fast.xlsx", help="Output .xlsx file")
    ...
    print("\nDirect Sakura XML MasterLog Builder v07 Node Skipping Build")
    print("=" * 72)
